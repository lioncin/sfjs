...
<form class="form-horizontal" name="mainForm" id="mainForm" action="<c:url value="/news/approve"/>" method="post">
        ...
        <div class="dataTable_wrapper">
          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tr>
              ...
              <td class="set"><a href="javascript:doSingleDelete('<%=id%>');" title="<f:message key="cm.delete"/>"><span class="glyphicon glyphicon-remove"></span></a></td>
            </tr>
            <%
                }
              } else {
