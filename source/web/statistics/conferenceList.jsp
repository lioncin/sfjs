...
<head>
<title><f:message key="ce.statistics.conference.manage"/></title>
...
<form class="form-horizontal" role="form" name="mainForm" id="mainForm" action="<c:url value="/statistics/conference/search"/>" method="post">
...
function doView(id) {
  submitForm('<c:url value="/statistics/conference/view"/>/' + id);
}
