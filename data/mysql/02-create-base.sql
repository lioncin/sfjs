...
DROP TABLE IF EXISTS CR_CUSTOMER;
CREATE TABLE CR_CUSTOMER (
  ID                  INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  TYPE                CHAR(1)                     COMMENT '客户类型（S - 供应商，A - 代理商）',
  LOGIN_USER_ID       INT UNSIGNED                COMMENT '登录用户ID',
  COMPANY_NAME        VARCHAR(100) NOT NULL       COMMENT '公司名称',
  LICENSE_NO          VARCHAR(20)                 COMMENT '营业执照号/统一社会信用代码',
  LEGAL_REP           VARCHAR(50)                 COMMENT '法定代表人',
  REGISTERED_CAPITAL  DECIMAL(8, 2)               COMMENT '注册资本',
  ADDRESS             VARCHAR(255)                COMMENT '地址',
  MAIN_BUSINESS       TEXT                        COMMENT '公司主营业务',
  ORG_CODE            VARCHAR(20)                 COMMENT '组织机构代码',
  ORG_TYPE            SMALLINT UNSIGNED           COMMENT '机构类型（1 - 机关，3 - 事业单位，5 - 企业，7 - 社会团体，9 - 其他组织机构）',
  BANK_NAME           VARCHAR(100)                COMMENT '开户银行',
  BANK_ACCOUNT_NO     VARCHAR(20)                 COMMENT '开户账号',
  TAX_NO              VARCHAR(20)                 COMMENT '税号',
  WEBSITE             VARCHAR(100)                COMMENT '公司网址',
  EMAIL               VARCHAR(255)                COMMENT '公司邮箱',
  CONTACT             VARCHAR(50)                 COMMENT '联系人',
  PHONE               VARCHAR(30)                 COMMENT '联系电话',
  ESTABLISHED_ON      DATE                        COMMENT '成立时间',
  HEADCOUNT           SMALLINT UNSIGNED           COMMENT '员工人数',
  INDUSTRY            VARCHAR(10)                 COMMENT '所属行业',
  RATING              DECIMAL(2, 1) DEFAULT 0     COMMENT '客户评级',
  STATUS              CHAR(1) DEFAULT 'A'         COMMENT '状态（P - 待审核，A - 正常，D - 停用）',
  REMARKS             VARCHAR(255)                COMMENT '备注',
  CREATED_AT          DATETIME NOT NULL,
  CREATED_BY          INT UNSIGNED NOT NULL,
  UPDATED_AT          DATETIME,
...
DROP TABLE IF EXISTS CR_BID;
CREATE TABLE CR_BID (
  ID                INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  GROUP_ID          INT UNSIGNED NOT NULL       COMMENT '招标组ID，主要用于版本控制',
  TYPE              CHAR(1)                     COMMENT '招标类型（P - 公开招标，I - 邀请投标）',
  PROJECT           VARCHAR(100) NOT NULL       COMMENT '项目',
  DESCRIPTION       TEXT                        COMMENT '内容',
  BUDGET            DECIMAL(8, 2)               COMMENT '预算',
  CLOSING_DATE      DATE                        COMMENT '截至日期',
  OPENING_DATE      DATETIME                    COMMENT '开标时间',
  STATUS            CHAR(1)                     COMMENT '状态（D - 已删除）',
  REMARKS           VARCHAR(255)                COMMENT '备注',
  CREATED_AT        DATETIME NOT NULL,
  CREATED_BY        INT UNSIGNED NOT NULL,
  UPDATED_AT        DATETIME,
...
DROP TABLE IF EXISTS CR_TENDER;
CREATE TABLE CR_TENDER (
  ID                INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  SUPPLIER_ID       INT UNSIGNED NOT NULL       COMMENT '供应商ID',
  BID_ID            INT UNSIGNED NOT NULL       COMMENT '招标ID',
  OFFER_PRICE       DECIMAL(8, 2)               COMMENT '总报价',
  OFFERED_AT        DATETIME                    COMMENT '投标时间',
  STATUS            CHAR(1)                     COMMENT '状态（P - 待确认，C - 已确认，S - 已投标，A - 中标）',
  REMARKS           VARCHAR(255)                COMMENT '备注',
  CREATED_AT        DATETIME NOT NULL,
  CREATED_BY        INT UNSIGNED NOT NULL,
  UPDATED_AT        DATETIME,
...
DROP TABLE IF EXISTS CR_OFFER;
CREATE TABLE CR_OFFER (
  ID                INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  TENDER_ID         INT UNSIGNED NOT NULL       COMMENT '投标人',
  NAME              VARCHAR(200)                COMMENT '名目',
  MAIN_MATERIAL     DECIMAL(8, 2)               COMMENT '主材',
  SUB_MATERIAL      DECIMAL(8, 2)               COMMENT '辅材',
  LABOR_COST        DECIMAL(8, 2)               COMMENT '人工',
  QUANTITY          TINYINT                     COMMENT '数量',
  PRICE             DECIMAL(8, 2)               COMMENT '报价',
  REMARKS           VARCHAR(255)                COMMENT '备注',
  CREATED_AT        DATETIME NOT NULL,
  CREATED_BY        INT UNSIGNED NOT NULL,
  UPDATED_AT        DATETIME,
