...
<head>
<title><f:message key="cm.exhibition.view"/></title>
...
<div class="row">
  <div class="col-md-12">
    <h3 class="page-header"><f:message key="ct.exhibitionEdit.mainTitle"/></h3>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.clocation"/></label>
          <div class="col-md-10">
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
          <p class="form-control-static"><f:masterCode code="exhibition.level.${entity.level}"/></p>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.count_1"/></label>
          <div class="col-md-10"><p class="form-control-static"><%=entity.getCount_1()%></p></div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.count_2"/></label>
          <div class="col-md-10"><p class="form-control-static"><%=entity.getCount_2()%></p></div>
        </div>
         <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.count_3"/></label>
          <div class="col-md-10"><p class="form-control-static"><%=entity.getCount_3()%></p></div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.feeScale"/></label>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
          <p class="form-control-static"><%=entity.getAddTime()%></p>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.description"/></label>
          <div class="col-md-10">
...
function changeStatus() {
    submitForm('<c:url value="/activity/status/"/>?id=' + $('#id').val());
}
