    ...
    <div class="panel panel-default">
      <div class="panel-heading"><f:message key="ct.contentEdit.mainTitle"/></div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10"><p class="form-control-static"><a href="javascript:showCatalogPopup('<%=catalogId%>');"><i class="fa fa-search"></i></a>&nbsp;<span id="catalogNameSpan"><%=StringUtil.getNonNull(catalogName)%></span><input type="hidden" name="catalogId" id="catalogId" value="<%=catalogId%>"/></p></div>
        </div>
        <div class="form-group">
...
function doSave() {
    submitForm('<c:url value="/content/save"/>');
}

function doCancel() {
    submitLink('<c:url value="/content/manage"/>');
}
</script>
</body>
</html>