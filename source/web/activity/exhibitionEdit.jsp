...
<head>
<title><f:message key="lm.exhibition.report"/></title>
...
<div class="row">
  <div class="col-md-12">
    <h3 class="page-header"><f:message key="lm.exhibition.report"/></h3>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading"><f:message key="lm.exhibition.content"/></div>
      <div class="panel-body">
         <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.name"/></label>
          <div class="col-md-10">
            <input class="form-control l" name="name" value="<%=StringUtil.getNonNull(entity.getName())%>" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.name_en"/></label>
          <div class="col-md-10">
            <input class="form-control l" name="name_en" value="<%=StringUtil.getNonNull(entity.getName_en())%>" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.clocation"/></label>
          <div class="col-md-10">
            <input class="form-control m" name="location" value="<%=StringUtil.getNonNull(entity.getLocation())%>" />
          </div>
        </div>
         <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.prepareFrom"/></label>
          <div class="col-md-10">
            <input class="form-control cal" name="prepareFrom" value="<f:date value="${entity.prepareFrom}"/>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.prepareTo"/></label>
          <div class="col-md-10">
            <input class="form-control cal" name="prepareTo" value="<f:date value="${entity.prepareTo}"/>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.holdFrom"/></label>
          <div class="col-md-10">
            <input class="form-control cal" name="holdFrom" value="<f:date value="${entity.holdFrom}"/>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.holdTo"/></label>
          <div class="col-md-10">
            <input class="form-control cal" name="holdTo" value="<f:date value="${entity.holdTo}"/>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.isRegular"/></label>
          <div class="col-md-10">
        ...
        <%if(entity.getId() == 0) {%>
          ...
          <div class="col-md-10">
          <input name="level" type="radio" id="level1" value="N" checked/><label for="level1"><f:message key="cm.exhibition.level1"/></label>
          <input name="level" type="radio" id="level2" value="P"/><label for="level2"><f:message key="cm.exhibition.level2"/></label>
          <input name="level" type="radio" id="level3" value="C"/><label for="level3"><f:message key="cm.exhibition.level3"/></label>
          </div>
        </div>
        <%} else { %>
          <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.conference.level"/></label>
          <div class="col-md-10">
          <input name="level" type="radio" id="level1" value="N"<%="N".equals(entity.getLevel()) ? " checked" : ""%>/><label for="level1"><f:message key="cm.exhibition.level1"/></label>
          <input name="level" type="radio" id="level2" value="P"<%="P".equals(entity.getLevel()) ? " checked" : ""%>/><label for="level2"><f:message key="cm.exhibition.level2"/></label>
          <input name="level" type="radio" id="level3" value="C"<%="C".equals(entity.getLevel()) ? " checked" : ""%>/><label for="level3"><f:message key="cm.exhibition.level3"/></label>
          </div>
        </div>
        <%} %>
        ...
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.count_1"/></label>
          <div class="col-md-10"><input class="form-control s" name="count_1" value="${entity.count_1}" /></div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.count_2"/></label>
          <div class="col-md-10"><input class="form-control s" name="count_2" value="${entity.count_2}" /></div>
        </div>
         <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.count_3"/></label>
          <div class="col-md-10"><input class="form-control s" name="count_3" value="${entity.count_3}" /></div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.feeScale"/></label>
          <div class="col-md-10"><input class="form-control s" name="feeScale" value="${entity.feeScale}" /></div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.hasAddProject"/></label>
          <div class="col-md-10">
          <input type="checkbox" name="hasAddProject" value="Y"<%="Y".equals(entity.getHasAddActivity()) ? " checked" : ""%>/>
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.addTime"/></label>
          <div class="col-md-10">
          <input class="form-control s" name="addTime" value="${entity.addTime}" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><f:message key="cm.exhibition.addScale"/></label>
          <div class="col-md-10">
          <input class="form-control s" name="addScale" value="${entity.addScale}" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-2 control-label"><span class="required">*</span><f:message key="cm.exhibition.description"/></label>
...
$(document).ready(function() {
    ...
    $('input[name="holdTime"]').attr('onblur', 'javascript:checkNumber2("holdTime");');
...
function checkIsEmpty(name) {
    ...
    if (!isEmpty(p1)) {
        if(name == "addTime"){
            ...
            showErrorMsg(name, '<f:message key="cm.exhibition.addTime.empty"/>');
        }
        if(name == "addScale"){
            if (p1 == '0.0') {
                return true;
            }
            showErrorMsg(name, '<f:message key="cm.exhibition.addScale.empty"/>');
        }
        if(name == "annualTime"){
            showErrorMsg(name, '<f:message key="cm.exhibition.annualTime.empty"/>');
        }
        return false;
    }
    return true;
...
function doSave() {
    ...
    if ($('input[name="hasAddProject"]').is( ":checked" ) ){
        flag1 = checkNumber("addTime");
        flag2 = checkNumber("addScale");
    }else{
        flag1 = checkIsEmpty("addTime");
        flag2 = checkIsEmpty("addScale");
    }
    if ($('input[name="isRegular"]').is( ":checked" ) ){
        flag3 = checkNumber2("annualTime");
    }else{
        flag3 = checkIsEmpty("annualTime");
    }
    if(flag1 & flag2 & flag3){
        if (checkRequired("name") & checkRequired("name_en") & checkRequired("location") & checkDate("prepareFrom") & checkDate("prepareTo") & checkDate("holdFrom") & checkDate("holdTo") 
                & checkNumber2("holdTime") & checkRequired("approver") & checkRequired("sponsor") & checkRequired2("documents") & checkRequired2("description")
                & checkRequired("organizer") & checkNumber("count_1") & checkNumber("count_2") & checkNumber2("count_3") & maxFee("feeScale") & checkNumberSize("count_1","count_2") 
